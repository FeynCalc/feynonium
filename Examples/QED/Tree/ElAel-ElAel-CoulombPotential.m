...
(* :Title: ElAel-ElAel-CoulombPotential														*)
...
(* :Summary:  El Ael -> El Ael, QED, Coulomb potential, tree			*)
...
description="El Ael -> El Ael, QED, Coulomb potential, tree";
If[ $FrontEnd === Null,
...
Paint[DiagramExtract[diags,2], ColumnsXRows -> {2, 1}, Numbering -> Simple,
...
amp[0] = FCFAConvert[CreateFeynAmp[DiagramExtract[diags,2],PreFactor->-1], IncomingMomenta->{p1,k1},
...
(* ::Text:: *)
(*This way we obtain the leading order contribution to the attractive Coulomb potential in the momentum space*)
...
knownResult = ((I)*(2 SMP["e"] SMP["m_e"])^2PauliXi[-I].PauliXi[I] 
PauliEta[-I].PauliEta[I])/(CSP[p1-p2]) /. sc->1;
FCCompareResults[amp[2],knownResult,
Text->{"\tCompare to Peskin and Schroeder, An Introduction to QFT, \
Eq 4.136:", "CORRECT.","WRONG!"}, Interrupt->{Hold[Quit[1]],Automatic}];
