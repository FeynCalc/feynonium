...
FCPrint[0,"Starting FeynOnium Test Suite on Mathematica ", $VersionNumber, "\n", UseWriteString->True];

Which[
testType===1,
fcTestList = (FileNames["*.mt", FileNameJoin[{$FeynOniumDirectory, "Tests", "*"}]]),
testType===2,
fcTestList = StringCases[
FileNames["*.mt",
FileNameJoin[{$FeynOniumDirectory, "Tests", "*"}],
